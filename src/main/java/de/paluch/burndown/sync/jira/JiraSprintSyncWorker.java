...
/**
 * Jira to Sprint-Model Synchronizer. <br> <br> Project: burdnown-chart <br> Autor: mark <br> Created: 25.03.2012 <br>
 * <br>
 */
public class JiraSprintSyncWorker
{
    ...
    public void syncSprint(JiraTeamSync teamSync, Sprint sprint) throws JiraSyncException
    {
        ...
        try
        {
            ...
            if (teamSync.isRapidBoard())
            {
                issueKeys = client.findRapidSprintIssues(teamSync.getProjectKey(), versionId);
            } else
            {
                issueKeys = client.findSprintIssues(teamSync.getProjectKey(), versionId);
            }
    ...
    private void calculateEffort(JiraTeamSync teamSync, String sprintId, List<SprintEffort> effort, JiraRestIssue issue)
    {
        ...
        } else
        {
            ...
            if (resolutionDate == null)
            {
                ...
                return;
            } else if (JiraIssueHelper.isInSprint(resolutionDate, effort))
            {
    ...
    private void calculateSprintGoal(List<JiraRestIssue> issues, JiraTeamSync teamSync, Sprint sprint)
    {
        ...
        for (JiraRestIssue issue : issues)
        {
            ...
            if (teamSync.isUnplanned() && JiraIssueHelper
